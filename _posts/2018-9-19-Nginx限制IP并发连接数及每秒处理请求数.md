...
description: 为了防止服务器被恶意采集或ddos攻击给搞死， 所以给限个速。这里主要使用Nginx的ngx_http_limit_req_module和ngx_http_limit_conn_module来控制访问量.这两个模块在Nginx中已内置， 在nginx.conf文件中加入相应的配置即可使用。
tags: [Nginx]
---
